...
common_settings.label_map = {1: 1, 2: 2, 3:3} ######### change*
common_settings.concepts_map = {1:'Easy', 2:'Mid', 3:'Hardest'} ######### change*
...
if __name__ == "__main__":
    ...
    condition = 'Dev_lev' # according to experiment conditions to change ################# change*
    feature_type = common_settings.model_name
    sub = 1101 #===change sub===
    sub = f'sub{sub:03d}'
    os.getcwd()
    working_dir = f'/home/xuchuanyong/Documents/DATA_analysis/MRI_SZU_HR/Decoding_mvpa/data_Dev_lev/{sub}' ################## change*
    mask_dir = '/home/xuchuanyong/Documents/DATA_analysis/MRI_SZU_HR/Decoding_mvpa/brainmask/'          ################## change*
    results_dir = '/home/xuchuanyong/Documents/DATA_analysis/MRI_SZU_HR/Decoding_mvpa/results/KFolds_MNI_space_Dev_lev' ################## change*
#   ---------------
