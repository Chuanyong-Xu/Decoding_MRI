...
common_settings.model_name = 'mvpa_rule_KFolds' 
...
for sub in subs:
    if __name__ == "__main__":
        ...
        #sub = 1101 #change sub ################# change*
        sub = f'sub{sub:03d}'
        os.getcwd()
        working_dir = f'../data_Dev_lev/{sub}' ################## change*
        mask_dir = '../brainmask/'          ################## change*
        results_dir = '../results/KFolds_MNI_space_Dev_lev' ################## change*
    #   ---------------
    ...
    # plotting------
    # plotting.plot_stat_map(pvalues_brain,
    #                        wholebrain_mask,
    #                        threshold = 0,
    #                        draw_cross = False,
