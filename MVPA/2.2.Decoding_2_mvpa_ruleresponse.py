...
if __name__ == "__main__":
    ...
    condition = 'rule_respons' # according to experiment conditions to change ################# change*
    feature_type = common_settings.model_name
    sub = 1101 #===change sub===
    sub = f'sub{sub:03d}'
    os.getcwd()
    working_dir = f'/home/xuchuanyong/Documents/DATA_analysis/MRI_SZU_HR/Decoding_mvpa/data_rule_respons/{sub}' ################## change*
    mask_dir = '/home/xuchuanyong/Documents/DATA_analysis/MRI_SZU_HR/Decoding_mvpa/brainmask/'          ################## change*
    results_dir = '/home/xuchuanyong/Documents/DATA_analysis/MRI_SZU_HR/Decoding_mvpa/results/KFolds_MNI_space_rule_respons' ################## change*
#   ---------------
